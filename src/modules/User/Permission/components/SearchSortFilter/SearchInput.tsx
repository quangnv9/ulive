...
export const SearchComponent = ({ currentFilter, history, location }: SearchComponentProps) => {
  ...
  return (
    <Form>
      <Form.Item>
        <div className="search-input-permission flex item-center">
          ...
          <div className="flex item-center">
            {keyword && <img className="mr-1-5 cursor-pointer" onClick={clearInputHandler} src={clearInput} alt="" />}
            <CommonButton htmlType="submit" loading={false} onClick={handleSearchByKeyWord} size="small">
              Search
            </CommonButton>
          </div>
        </div>
